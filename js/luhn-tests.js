...
describe("Luhn Validation", function() {
    ...
    describe("Random examples from credit card generator", function() {
        for ( var card in cards ) {
            for ( var i in cards[card] ) {
                var cardNumber = cards[card][i];
                it("should pass " + card  +" - " + cardNumber, function() {
                    luhn.validate(cardNumber).should.be.true;
                });
            }
        }
    });
